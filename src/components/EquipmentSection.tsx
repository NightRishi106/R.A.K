    ...
    <section id="equipment" className="relative py-24 px-4 md:px-8 lg:px-16 overflow-hidden border-b border-bronze-dark/40">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg md:text-xl text-ancient-beige/65 font-vintage italic leading-relaxed">
            ...
            {equipmentList.map(eq => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && <div className="absolute left-0 inset-y-0 w-[3px] bg-gold-warm z-10" />}

                  <div className={`relative z-10 p-2.5 rounded border transition-colors shrink-0 ${
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-auto">
                  ...
                  <div 
                    className="flex flex-col items-center justify-center p-4 bg-[#110d0a] rounded border border-bronze-dark/50 shadow-inner h-52 relative overflow-hidden group cursor-pointer"
                    onClick={() => activeEquipment.imageUrl && setLightboxImage(activeEquipment.imageUrl)}
                  >
                    {/* Equipment Background Image */}
                    {activeEquipment.imageUrl && (
                      <img 
    ...
    <AnimatePresence>
      {lightboxImage && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex items-center justify-center p-0 lg:p-12 bg-black/95 backdrop-blur-md cursor-zoom-out"
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1 }}
            exit={{ scale: 0.95 }}
            className="relative w-full h-full lg:w-auto lg:h-auto lg:max-w-6xl lg:max-h-[90vh] flex flex-col items-center justify-center cursor-default"
            onClick={(e) => e.stopPropagation()}
          >
            <button 
              onClick={() => setLightboxImage(null)}
              className="absolute top-4 right-4 lg:-top-12 lg:-right-12 text-white/80 hover:text-gold-warm transition-colors p-3 z-10 bg-black/50 lg:bg-transparent rounded-full lg:rounded-none backdrop-blur-sm lg:backdrop-blur-none"
            >
            ...
            <img 
              ...
              className="w-full h-full lg:h-auto lg:max-h-[85vh] object-contain lg:rounded border-0 lg:border lg:border-gold-faded/20 shadow-2xl"
              referrerPolicy="no-referrer"
            />
          </motion.div>
        </motion.div>
